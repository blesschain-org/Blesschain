...
pub mod genesis_config_presets {
	...
	use crate::{
	    ...
	    AuraConfig, BalancesConfig, GrandpaConfig,   
    ...
    fn get_public_from_seed<TPublic: sp_core::Pair>(
	    seed: &str,
    ) -> <TPublic as sp_core::Pair>::Public {
	...
	pub fn development_config_genesis() -> Value {
	    ...
	    aura: AuraConfig {
		    authorities: vec![
			    get_public_from_seed::<sp_core::sr25519::Pair>("Alice").into(),
    		],
    	},
	    grandpa: GrandpaConfig {
		    authorities: vec![
			    (
				    get_public_from_seed::<sp_core::ed25519::Pair>("Alice").into(),
				    1,
			    ),
		    ],
	    },
...
pub fn local_testnet_config_genesis() -> Value {
	let endowment = <MinimumBalance as Get<Balance>>::get().max(1) * 1000;
	frame_support::build_struct_json_patch!(RuntimeGenesisConfig {
		balances: BalancesConfig {
			balances: Sr25519Keyring::iter()
		...
		aura: AuraConfig {
			authorities: vec![
				get_public_from_seed::<sp_core::sr25519::Pair>("Alice").into(),
				get_public_from_seed::<sp_core::sr25519::Pair>("Bob").into(),
			],
		},
		grandpa: GrandpaConfig {
			authorities: vec![
				(get_public_from_seed::<sp_core::ed25519::Pair>("Alice").into(), 1),
				(get_public_from_seed::<sp_core::ed25519::Pair>("Bob").into(), 1),
			],
		},
		sudo: SudoConfig { key: Some(Sr25519Keyring::Alice.to_account_id()) },
	})
	...
	pub fn get_preset(id: &PresetId) -> Option<Vec<u8>> {
	    ...
	    sp_genesis_builder::LOCAL_TESTNET_RUNTIME_PRESET => local_testnet_config_genesis(),
	    _ => return None,
        };
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: alloc::borrow::Cow::Borrowed("blesschain"),
	impl_name: alloc::borrow::Cow::Borrowed("blesschain"),
	authoring_version: 1,
	spec_version: 0,
	impl_version: 1,
...
parameter_types! {
	pub const AuraSlotDuration: u64 = 7000;
}
...
impl pallet_aura::Config for Runtime {
	...
	type SlotDuration = AuraSlotDuration;
...
impl_runtime_apis! {
	...
	impl sp_consensus_aura::AuraApi<Block, AuraId> for Runtime {
		fn slot_duration() -> sp_consensus_aura::SlotDuration {
			sp_consensus_aura::SlotDuration::from_millis(AuraSlotDuration::get())
		}
